...
if(!empty($matches)) {
    ?>
    <div class="ticker-wrap my-2" style="background-color: <?php echo $bgColor;?>">
        <div
                class="ticker"
                style="
        ...
        >
            <?php foreach ($matches as $match) : ?>
                ...
                <div class="ticker__headline">
                    <div class="fixture-wrapper py-2 px-3 align-items-center" style="border: 1px solid <?php echo $textColor; ?>">
                        <div class="fixture-match" style="font-size: <?php echo $fontSize; ?>; color: <?php echo $textColor; ?>;">
                            ...
                            &nbsp;vs&nbsp;
                            <div class="away-team teams" data-bs-toggle="modal" data-bs-target="#teamModal" data-match="<?php echo $matchId;?>" data-sport="<?php echo $sport; ?>" data-team="<?php echo $awayTeamKey;?>">
